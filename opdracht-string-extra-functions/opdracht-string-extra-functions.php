    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <li><strong><?= strlen($fruit1) ?></strong></li>
                <li><strong><?= strpos($fruit1, "o") ?></strong></li>
            </ul>
            ...
            <ul>
                ...
                <li><strong><?= strrpos($fruit2, "a") ?></strong></li>
                <li><strong><?= strtoupper($fruit2) ?></strong></li>
            </ul>
    		...
    		<ul> 
                ...
                <li><strong><?= str_replace($lettertje, $cijfertje, $langsteWoord) ?></strong></li>
    		</ul>
